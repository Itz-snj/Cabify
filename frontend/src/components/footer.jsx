                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-gray-400">
                            Your trusted ride-hailing partner. Available 24/7 for your transportation needs.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><a href="#" className="hover:text-white transition-colors duration-300">City Rides</a></li>
                            <li><a href="#" className="hover:text-white transition-colors duration-300">Airport Transfer</a></li>
                            <li><a href="#" className="hover:text-white transition-colors duration-300">Hourly Rental</a></li>
                            <li><a href="#" className="hover:text-white transition-colors duration-300">Business Travel</a></li>
                        </ul>
                    </div>
