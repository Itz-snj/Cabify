  ...
  return (
    (<div
      ...
      <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
       Login to your account or sign up with your email address to get started.
      </p>
      <form className="my-8" onSubmit={handleSubmit(onSubmit)}>
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
          ...
          <LabelInputContainer>
            ...
            <Input {...register("middlename")} id="middlename" placeholder="kumar" type="text" />
          </LabelInputContainer>
          <LabelInputContainer>
        ...
        <LabelInputContainer className="mb-4">
          ...
          <Input {...register("email", { required: true, pattern: /^\S+@\S+$/i })} id="email" placeholder="projectmayhem@fc.com" type="email" />
        </LabelInputContainer>
        <LabelInputContainer className="mb-4">
